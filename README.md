...
1. Download the you want to install.
...
Then define how the **sense-autonavigation** should behave:
...
Based on the Sense-Navigation extension created by **Stefan Walther**
